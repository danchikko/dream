			...
			<div className='luptop-block'>
				<div className='luptop'>
                    <video width="300" height="200" controls>
                        <source src='https://youtu.be/XKC4auDn07U'/>
                    </video>
                    <iframe width="727" height="409" src="https://www.youtube.com/embed/XKC4auDn07U" title="Международный Университет Кыргызстана    1 августа 2022г." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
			</div>
		</div>
	)
