		...
		<div className='Facultycontainer'>
			...
			<div className='FacultyInfoBlock'>
				...
				<div className='ISIT'>
					...
					<ul>
						<li>
							<AiOutlineCheckCircle /> Системный администратор
						</li>
						<li>
							<AiOutlineCheckCircle /> Программист
						</li>
						<li>
							<AiOutlineCheckCircle /> Специалист по
							информационной безопасности
						</li>
						<li>
							<AiOutlineCheckCircle /> Аналитик данных
						</li>
						<li>
							<AiOutlineCheckCircle /> Инженер по разработке
							программного обеспечения
						</li>
						<li>
							<AiOutlineCheckCircle /> Специалист по базам данных
						</li>
						<li>
							<AiOutlineCheckCircle /> Системный аналитик
						</li>
						<li>
							<AiOutlineCheckCircle /> Специалист по разработке
							веб-сайтов
						</li>
					</ul>
				</div>
